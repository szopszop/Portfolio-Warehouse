package com.szymontracz.service;


import com.szymontracz.entity.User;
import com.szymontracz.mapper.UserMapper;
import com.szymontracz.amazon.bucket.BucketName;
import com.szymontracz.amazon.filestore.FileStore;
import com.szymontracz.model.UserDto;
import com.szymontracz.repository.UserRepository;
...
public class UserServiceImpl implements UserService {
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        ...
        return new User(user.getId(), user.getUsername(), user.getEmail(), null, user.getPassword(), user.getRole());
    }
}
